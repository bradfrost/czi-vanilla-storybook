module.exports = plop => {
  ...
  plop.setGenerator('component', {
    ...
    actions: [
      ...
      },
      {
        ...
        templateFile: 'plop-templates/Component/tests/Component.test.js.hbs'
      },
      {
        type: 'add',
  ...
  plop.setGenerator('page', {
    ...
    actions: [
      {
        type: 'add',
        path: '.storybook/pages/{{pascalCase name}}/{{pascalCase name}}.js',
        templateFile: 'plop-templates/Page/Page.js.hbs'
      },
      {
        type: 'add',
        path:
          '.storybook/pages/{{pascalCase name}}/{{pascalCase name}}.stories.js',
